        ...
        <tr style="width:100%">
          <td>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding:20px 20px;max-width:440px">
              <tbody>
                <tr>
                  <td><img alt="Stripe" height="26" src="/static/geriga-dark-logo.png" style="display:block;outline:none;border:none;text-decoration:none" width="90" />
                    ...
                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="background:rgba(0,0,0,.05);border:2px solid #FF6666;border-radius:5px;margin:16px auto 14px;vertical-align:middle;max-width:300px">
                      <tbody>
                        <tr>
                          <td>
                            <p style="font-size:32px;line-height:40px;margin:0 auto;color:#000;display:inline-block;font-family:Roboto, sans-serif;font-weight:700;letter-spacing:6px;padding-bottom:8px;padding-top:8px;width:100%;text-align:center">123456</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
